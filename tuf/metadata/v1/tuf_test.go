...
var metaTC = []struct {
	...
	{"one", 1, map[string]MetaVersionInfo{
		"root1.json":   MetaVersionInfo{Version: 1},
		"target1.json": MetaVersionInfo{Version: 1},
	}},
	{"two", 2, map[string]MetaVersionInfo{
		"root2.json":   MetaVersionInfo{Version: 2},
		"target2.json": MetaVersionInfo{Version: 2},
	}},
}
