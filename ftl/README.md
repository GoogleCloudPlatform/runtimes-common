...
## Releases
Currently FTL is released in .par format for each supported runtime.  The latest release is v0.6.2, changelog [here](https://github.com/GoogleCloudPlatform/runtimes-common/blob/master/ftl/CHANGELOG.md)

### node

[v0.6.2](https://storage.googleapis.com/gcp-container-tools/ftl/node/node-v0.6.2/ftl.par)
...
[v0.6.2](https://storage.googleapis.com/gcp-container-tools/ftl/node/python-v0.6.2/ftl.par)
...
### php
[v0.6.2](https://storage.googleapis.com/gcp-container-tools/ftl/php/php-v0.6.2/ftl.par)
