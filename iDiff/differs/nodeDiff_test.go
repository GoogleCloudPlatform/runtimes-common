...
func TestGetNodePackages(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expected: map[string]map[string]utils.PackageInfo{
				"pac1": {"testDirs/packageOne/node_modules/pac1/package.json": {Version: "1.0", Size: "4096"}},
				"pac2": {"testDirs/packageOne/usr/local/lib/node_modules/pac2/package.json": {Version: "2.0", Size: "4096"}},
				"pac3": {"testDirs/packageOne/node_modules/pac3/package.json": {Version: "3.0", Size: "4096"}}},
		},
		{
			descrip: "Multi version packages",
			path:    "testDirs/packageMulti",
			expected: map[string]map[string]utils.PackageInfo{
				"pac1": {"testDirs/packageMulti/node_modules/pac1/package.json": {Version: "1.0", Size: "4096"}},
				"pac2": {"testDirs/packageMulti/node_modules/pac2/package.json": {Version: "2.0", Size: "4096"},
					"testDirs/packageMulti/usr/local/lib/node_modules/pac2/package.json": {Version: "3.0", Size: "4096"}}},
		},
	}
